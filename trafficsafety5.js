...
var traffic5 = Paper.image('traffic5.png', 0, 0, 350, 400).toDefs();
...
function handler01() {
  location.replace('trafficsafety4.html');
}
right.use().transform('t330, 7').click(handler02).appendTo(topArea);
function handler02() {
  location.replace('trafficsafety6.html');
}
traffic5.use().transform('t5, 35').appendTo(topArea);
